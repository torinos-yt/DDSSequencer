...
// MaterialPropertySelector by keijiro
// https://github.com/keijiro/KlakSpout/blob/main/Packages/jp.keijiro.klak.spout/Editor/MaterialPropertySelector.cs
internal static class MaterialPropertySelector
{
    #region Public method

    // Material property dropdown list
    public static void DropdownList(SerializedProperty rendererProperty, SerializedProperty materialProperty)
    {
        ...
        var newIndex = EditorGUILayout.Popup("Target Property", index, names);
